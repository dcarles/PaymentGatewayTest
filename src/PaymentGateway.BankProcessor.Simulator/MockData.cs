...
namespace PaymentGateway.BankProcessor.Simulator
{
    public static class MockData
    {
        private static readonly List<Card> Cards =
            ...
            {
                // Visa Valid
                new Card(){CardNumber = "4242424242424242", Cvv = "100", ResponseCode = "1000"},
                ...
                // Amex Valid
                new Card(){CardNumber = "345678901234564", Cvv = "1051", ResponseCode = "1000"},
                ...
                new Card(){CardNumber = "2223000010479399", Cvv = "289", ResponseCode = "1000"},
                // Master Invalid
                new Card(){CardNumber = "5199992312641465", Cvv = "019", ResponseCode = "2000", ResponseMessage = "Restricted card"},
                new Card(){CardNumber = "5454545454545454", Cvv = "123", ResponseCode = "2000", ResponseMessage = "Issuer initiated a stop payment (revocation order) for this authorization"},
